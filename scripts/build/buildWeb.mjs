...
const buildConfigs = [
    ...
    },
    {
        ...
        outfile: "dist/Dussicord.user.js",
        banner: {
...
async function buildExtension(target, files) {
    const entries = {
        "dist/Dussicord.js": await readFile("dist/browser/extension.js"),
        "dist/Dussicord.css": await readFile("dist/browser/extension.css"),
...
const appendCssRuntime = readFile("dist/Dussicord.user.css", "utf-8").then(content => {
    const cssRuntime = `unsafeWindow._vcUserScriptRendererCss=\`${content.replaceAll("`", "\\`")}\``;

    return appendFile("dist/Dussicord.user.js", cssRuntime);
});
