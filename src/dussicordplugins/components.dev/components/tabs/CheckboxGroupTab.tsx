...
import { DussicordIcon } from "../icons/DussicordIcon";
...
const OPTIONS_WITH_ICONS: CheckboxGroupOption[] = [
    { value: "item1", label: "Item with icon", description: "This option has an icon", leadingIcon: DussicordIcon },
    { value: "item2", label: "Another with icon", leadingIcon: DussicordIcon },
    { value: "item3", label: "Third with icon", leadingIcon: DussicordIcon },
];
