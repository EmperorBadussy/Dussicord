...
const ICON_OPTIONS: RadioOption[] = [
    { value: "item1", name: "Item with icon", description: "This option has an icon", icon: DussicordIcon },
    { value: "item2", name: "Another with icon", icon: DussicordIcon },
    { value: "item3", name: "Third with icon", icon: DussicordIcon },
];
