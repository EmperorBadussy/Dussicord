...
import { settings } from "@dussicordplugins/fileUpload/settings";
import { ServiceType, ShareXUploaderConfig, UploadResponse } from "@dussicordplugins/fileUpload/types";
