...
export default definePlugin({
    ...
    authors: [DussicordDevs.ZcraftElite, DussicordDevs.square],
    ...
    settingsAboutComponent: () => (
        <>
            ...
            <Paragraph>
                ...
                <br /><br />
                NOTE: While on most computers this plugin will not impact performance any more than your average Dussicord extension,
