...
import { Devs, DussicordDevs, GUILD_ID, SUPPORT_CHANNEL_ID, SUPPORT_CHANNEL_IDS, VC_SUPPORT_CHANNEL_IDS } from "@utils/constants";
...
migratePluginToSettings(true, "DussicordHelper", "NoBulletPoints", "noBulletPoints");
migratePluginToSettings(true, "DussicordHelper", "NoModalAnimation", "noModalAnimation");
        ...
        async CHANNEL_SELECT({ channelId }) {
            ...
            if (VC_SUPPORT_CHANNEL_IDS.includes(channelId) && !clicked) {
                return Alerts.show({
                    ...
                    body: "Before asking for help. Check updates and if this issue is actually caused by Dussicord!",
                    confirmText: "Dussicord Support",
                    onConfirm() {
