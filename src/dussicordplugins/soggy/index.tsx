...
const settings = definePluginSettings({
    ...
    songLink: {
        ...
        type: OptionType.STRING,
        default: "https://github.com/Dussicord/Equibored/raw/main/sounds/soggy/song.mp3?raw=true",
        onChange(newValue) {
    ...
    boopLink: {
        ...
        type: OptionType.STRING,
        default: "https://github.com/Dussicord/Equibored/raw/main/sounds/soggy/honk.wav?raw=true",
        onChange(newValue) {
