...
export default definePlugin({
    ...
    start() {
        SettingsPlugin.customEntries.push({
            key: "dussicord_login_with_qr",
            title: getIntlMessage("USER_SETTINGS_SCAN_QR_CODE"),
            Component: openQrModal,
            Icon: QrCodeIcon
        });
        SettingsPlugin.settingsSectionMap.push(["DussicordLoginWithQR", "dussicord_login_with_qr"]);
        preload();
    },

    stop() {
        removeFromArray(SettingsPlugin.customEntries, e => e.key === "dussicord_login_with_qr");
        removeFromArray(SettingsPlugin.settingsSectionMap, entry => entry[1] === "dussicord_login_with_qr");
        unload();
    },
});
