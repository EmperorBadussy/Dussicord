...
import { toggleEnabled } from "@dussicordplugins/dussicordHelper/utils";
...
const BUILT_IN_CATEGORIES: CommandCategory[] = [
    {
        ...
        label: "Quick Actions",
        description: "Common Dussicord shortcuts"
    },
    {
        id: "plugins",
        label: "Plugins",
        description: "Manage Dussicord and Vencord plugins"
    },
    {
    ...
    },
    {
        id: "updates",
        label: "Updates",
        description: "Stay up to date with Dussicord"
    },
    {
        id: "discord-settings",
...
const BUILT_IN_COMMANDS: CommandEntry[] = [
    {
        id: "open-dussicord-settings",
        label: "Open Dussicord Settings",
        keywords: ["settings", "dussicord"],
        categoryId: DEFAULT_CATEGORY_ID,
        tags: [TAG_NAVIGATION, TAG_CORE],
        handler: () => SettingsRouter.openUserSettings("dussicord_main_panel")
    },
    {
        ...
        handler: () => SettingsRouter.openUserSettings("dussicord_plugins_panel")
    },
    {
        id: "reload-windows",
...
function registerUpdateCommands() {
    registerCommand({
        ...
        description: "Checks for Dussicord updates",
    ...
    registerCommand({
        ...
        description: "Opens the Dussicord changelog",
        keywords: ["updates", "changelog"],
        categoryId: "updates",
        tags: [TAG_DEVELOPER, TAG_NAVIGATION],
        handler: () => SettingsRouter.openUserSettings("dussicord_changelog_panel")
    });
}
...
function registerPluginChangeCommands() {
    ...
    registerCommand({
        id: "restart-dussicord",
        label: "Restart Dussicord",
...
function registerCustomizationCommands() {
    ...
    registerCommand({
        ...
        handler: () => SettingsRouter.openUserSettings("dussicord_themes_panel")
    });
}
