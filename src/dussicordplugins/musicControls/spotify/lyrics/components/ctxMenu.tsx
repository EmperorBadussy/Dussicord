...
import { providers } from "@dussicordplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@dussicordplugins/musicControls/spotify/lyrics/providers/store";
