...
import { LyricsData, Provider } from "@dussicordplugins/musicControls/spotify/lyrics/providers/types";
import { Track } from "@dussicordplugins/musicControls/spotify/SpotifyStore";
...
export async function getLyricsLrclib(track: Track): Promise<LyricsData | null> {
    ...
    const response = await fetch(url, {
        headers: {
            "User-Agent": "SpotifyLyrics for Dussicord (https://github.com/Masterjoona/vc-spotifylyrics)"
        }
    });
