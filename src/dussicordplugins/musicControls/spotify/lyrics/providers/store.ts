...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@dussicordplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@dussicordplugins/musicControls/spotify/SpotifyStore";
