...
const settings = definePluginSettings({
    imageSource: {
        ...
        default: "https://github.com/Dussicord/Equibored/blob/main/icons/jumpscare/troll.gif?raw=true"
    },
    audioSource: {
        type: OptionType.STRING,
        description: "Sets the audio url of the jumpscare",
        default: "https://github.com/Dussicord/Equibored/raw/main/sounds/jumpscare/trollolol.mp3?raw=true"
    },
    chance: {
