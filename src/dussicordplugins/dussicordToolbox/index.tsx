        ...
        >
            {(_, { isShown }) => (
                <HeaderBarButton
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "Dussicord Toolbox"}
                    icon={Icon}
                    selected={isShown}
                />
            )}
...
migratePluginSettings("DussicordToolbox", "VencordToolbox");
export default definePlugin({
    name: "DussicordToolbox",
    description: "Adds a button next to the inbox button in the channel header that houses Dussicord quick actions",
