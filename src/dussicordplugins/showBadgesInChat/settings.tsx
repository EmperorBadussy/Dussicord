...
const settings = definePluginSettings({
    showDussicordDonor: {
        ...
        description: "Enable to show Dussicord Donor badges in chat.",
        hidden: true,
        default: true
    },
    DussicordDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Dussicord Donor badges.",
        hidden: true,
        default: 0
    },
    showDussicordContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show Dussicord Contributor badges in chat.",
        hidden: true,
        default: true
    },
    DussicordContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Dussicord Contributor badge.",
        hidden: true,
        default: 1
    },
    showVencordDonor: {
...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        { src: "https://badge.equicord.org/donor.webp", shown: settings.store.showDussicordDonor, title: "Dussicord donor badges", key: "DussicordDonor", position: settings.store.DussicordDonorPosition },
        { src: "https://equicord.org/assets/favicon.png", shown: settings.store.showDussicordContributor, title: "Dussicord contributor badge", key: "DussicordContributer", position: settings.store.DussicordContributorPosition },
    ...
    useEffect(() => {
        images.forEach(image => {
            switch (image.key) {
                case "DussicordDonor":
                    settings.store.DussicordDonorPosition = image.position;
                    settings.store.showDussicordDonor = image.shown;
                    break;
                case "DussicordContributer":
                    settings.store.DussicordContributorPosition = image.position;
                    settings.store.showDussicordContributor = image.shown;
                    break;
                case "VencordDonor":
