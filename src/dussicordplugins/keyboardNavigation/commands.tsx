...
export const actions: ButtonAction[] = [
    { id: "openDussicordSettings", label: "Open Dussicord tab", callback: async () => await SettingsRouter.openUserSettings("dussicord_main_panel"), registrar: "Dussicord" },
    { id: "openPluginSettings", label: "Open Plugin tab", callback: () => SettingsRouter.openUserSettings("dussicord_plugins_panel"), registrar: "Dussicord" },
    { id: "openThemesSettings", label: "Open Themes tab", callback: () => SettingsRouter.openUserSettings("dussicord_themes_panel"), registrar: "Dussicord" },
    { id: "openUpdaterSettings", label: "Open Updater tab", callback: () => SettingsRouter.openUserSettings("dussicord_updater_panel"), registrar: "Dussicord" },
    { id: "openDussicordCloudSettings", label: "Open Cloud tab", callback: () => SettingsRouter.openUserSettings("dussicord_cloud_panel"), registrar: "Dussicord" },
    { id: "openBackupSettings", label: "Open Backup & Restore tab", callback: () => SettingsRouter.openUserSettings("dussicord_backup_restore_panel"), registrar: "Dussicord" },
    { id: "restartClient", label: "Restart Client", callback: () => relaunch(), registrar: "Dussicord" },
    { id: "openQuickCSSFile", label: "Open Quick CSS File", callback: () => VencordNative.quickCss.openEditor(), registrar: "Dussicord" },
    { id: "openSettingsFolder", label: "Open Settings Folder", callback: async () => showItemInFolder(await VencordNative.settings.getSettingsDir()), registrar: "Dussicord" },
    { id: "openInGithub", label: "Open in Github", callback: async () => VencordNative.native.openExternal(await getRepo()), registrar: "Dussicord" },
        ...
        id: "checkForUpdates", label: "Check for Updates", callback: async () => {
            ...
            if (isOutdated) {
                setTimeout(() => showNotification({
                    title: "A Dussicord update is available!",
                    body: "Click here to view the update",
                    permanent: true,
                    noPersist: true,
                    onClick() {
                        SettingsRouter.openUserSettings("dussicord_updater_panel");
                    }
                }), 10_000);
            } else {
                Toasts.show({
