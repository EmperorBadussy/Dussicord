...
export default definePlugin({
    ...
    authors: [DussicordDevs.zoodogood, DussicordDevs.keircn],
    ...
    async start() {
        SettingsPlugin.customEntries.push({
            key: "dussicord_i_remember_you",
            title: "I Remember You",
            Component: () => <DataUI usersCollection={data.usersCollection} />,
            Icon: EyeIcon
        });
        SettingsPlugin.settingsSectionMap.push(["DussicordIRememberYou", "dussicord_i_remember_you"]);
    ...
    stop() {
        removeFromArray(SettingsPlugin.customEntries, e => e.key === "dussicord_i_remember_you");
        removeFromArray(SettingsPlugin.settingsSectionMap, entry => entry[1] === "dussicord_i_remember_you");
