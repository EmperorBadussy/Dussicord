...
export default definePlugin({
    ...
    authors: [DussicordDevs.SomeAspy, Devs.thororen],
    dependencies: ["AudioPlayerAPI"],
    settings,
    start() {
        croissant = createAudioPlayer("https://github.com/Dussicord/Equibored/raw/main/sounds/equissant/croissant.mp3", { persistent: true });
