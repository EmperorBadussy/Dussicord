...
export const settings = definePluginSettings({
    format: {
        ...
        default: "{buildChannel} {buildNumber} ({buildHash}) | {dussicordName} {dussicordVersion} ({dussicordHash})",
        restartNeeded: true
    }
});
...
export const settingVariables = [
    ...
    "",
    "Dussicord Variables:",
    "{dussicordIcon} - Dussicord icon",
    "{dussicordVersion} - Version of Dussicord (e.g. 1.0.0)",
    "{dussicordHash} - Dussicord build hash (e.g. 123456789)",
    "{dussicordPlatform} - Platform Dussicord is running on (e.g. Dev Build)",
    "",
