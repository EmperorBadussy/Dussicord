...
export function FormatSetting(setValue) {
    ...
    const [state, setState] = useState(format ?? "{buildChannel} {buildNumber} ({buildHash}) | {dussicordName} {dussicordVersion} ({dussicordHash})");
    ...
    return (
        <section>
            ...
            <textarea
                ...
                placeholder="{buildChannel} {buildNumber} ({buildHash}) | {dussicordName} {dussicordVersion} ({dussicordHash})"
                rows={1}
                ref={el => {
                    if (el) {
