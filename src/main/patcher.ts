...
console.log("[Dussicord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Dussicord");
    ...
    console.log("[Dussicord] Running in vanilla mode. Not loading Dussicord");
}

console.log("[Dussicord] Loading original Discord app.asar");
