...
export function DonateButton({
    ...
    className,
    ...props
}: Partial<ButtonProps> & { dussicord?: boolean; }) {
    const link = dussicord ? "https://github.com/sponsors/thororen1234" : "https://github.com/sponsors/Vendicated";
    return (
        <Button
            {...props}
            variant="none"
...
export function TranslateButton({
    ...
    const link = "https://weblate.equicord.org/projects/dussicord/";
    return (
        <Button
            {...props}
            variant="none"
