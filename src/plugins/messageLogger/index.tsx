...
import { Devs, EQUIBOT_USER_ID, DussicordDevs, SUPPORT_CHANNEL_ID, VC_SUPPORT_CATEGORY_ID, VENBOT_USER_ID } from "@utils/constants";
...
export default definePlugin({
    ...
    authors: [Devs.rushii, Devs.Ven, Devs.AutumnVN, Devs.Nickyux, Devs.Kyuuhachi, DussicordDevs.justjxke],
